    ...
    <div className="p-8 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8 hover:shadow-lg transition-all border border-gray-100">
        ...
        <p className="text-gray-600">
          The Dadi Academy Block is dedicated to education and skill development,
          providing comprehensive learning resources and training programs.
        </p>
      </div>
      ...
      {!showAgent1 ? (
        ...
        >
          <CardHeader className="flex flex-row items-center gap-4">
            ...
            <CardTitle className="text-gray-800">Recruitment Funnel Chatbot</CardTitle>
          </CardHeader>
        </Card>
      ) : (
        <div className="rounded-lg overflow-hidden shadow-md mb-6 border border-gray-200" style={{ minHeight: '700px' }}>
          <div className="bg-primary/10 p-3 flex justify-between items-center">
            <h3 className="font-medium text-gray-800">Recruitment Funnel Chatbot</h3>
            <button 
          ...
          <iframe
             src="https://udify.app/chatbot/r1SL4jJxcR0EuESd"
